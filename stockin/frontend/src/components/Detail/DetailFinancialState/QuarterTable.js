...
import { getFs } from '../../../store/financialstats';
...
const RenderTableItem = item => {
  ...
  response = {...response, quarter : quarter, sales : sales, operatingProfit : operatingProfit,
              netIncome : netIncome, operatingMargin : operatingMargin, netProfitMargin : netProfitMargin,
