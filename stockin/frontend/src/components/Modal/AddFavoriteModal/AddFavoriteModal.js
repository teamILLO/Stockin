...
import MakeNewGroupModal from '../EditModal/MakeNewGroupModal';
  ...
  return (
    <Modal onOpen={() => setOpen(true)} open={open} trigger={props.trigger}>
      ...
      <Modal.Content>
        ...
        <MakeNewGroupModal trigger={<Button content="그룹 추가" className="groupAddButton" />} />
      </Modal.Content>
      <Modal.Actions>
        <Button color="black" content="취소" onClick={() => setOpen(false)} />
        <Button
          content="확인"
          labelPosition="right"
          icon="checkmark"
